...
local dir_data="C:/Users/thepe/Documents/GitHub/ACRE-Wu/data/" // please change directories of data and output accordingly
local dir_output="C:/Users/thepe/Documents/GitHub/ACRE-Wu/results_static/"
...
syntax,job(integer) // 0 if full gender sample; otherwise, specify a job rank from 1 to 4 
	...
	log using "`dir_output'summary_stats_0`job'.log",replace
	count 
